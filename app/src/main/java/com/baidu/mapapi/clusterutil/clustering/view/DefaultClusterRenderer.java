...
public class DefaultClusterRenderer<T extends ClusterItem> implements
     ...
     * 修改聚合数组规则
     */
    private static final int[] BUCKETS = {10,20, 30,50, 100, 200, 500, 1000,2000,3000,5000,10000,20000,30000,50000,80000,100000};
...
//        LogUtils.e("车辆数："+bucket);
        return  String.valueOf(size)+"辆";
    }
...
//        LogUtils.e("遮盖物数量："+ size);
    ...
    private class RenderTask implements Runnable {
        ...
        public void run() {
            ...
            if (mMap==null||mMap.getMapStatus()==null||mMap.getMapStatus().bound==null){
//                LogUtils.e("map为空");
                return;
            }
